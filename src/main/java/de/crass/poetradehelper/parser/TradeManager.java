...
//                    }
    ...
    public ObservableList<String> getCharacterList() {
        return poeApiParser.getCharacters();
    }

    public ObservableList<String> updateCharacter(String account) {
        return poeApiParser.fetchChars(account);
    }
